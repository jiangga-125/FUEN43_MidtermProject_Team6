...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-EH4L77K\\SQLEXPRESS;Database=Member;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__MemberPo__0CF04B3889683100");

            entity.ToTable(tb => tb.HasTrigger("trg_MemberPoints_UpdateTime"));
        ...
        {
            entity.HasKey(e => e.RuleAppId).HasName("PK__RuleAppl__70448604C9545B62");
            ...
            entity.Property(e => e.RuleAppId).HasColumnName("RuleAppID");
